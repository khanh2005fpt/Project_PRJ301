        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
                <c:if test="${indexPvsN > 1}">
                    <li class="page-item">
                        <a class="page-link" href="category?cateid=${tag}&index=${indexPvsN - 1}">Trước</a>
                    </li>
                </c:if>

                <c:forEach begin="1" end="${numpage}" var="i">
                    <li class="page-item ${i == indexPvsN ? "active" : ""}">
                        <a class="page-link" href="category?cateid=${tag}&index=${i}">${i}</a>
                    </li>
                </c:forEach>

                <c:if test="${indexPvsN < numpage}">
                    <li class="page-item">
                        <a class="page-link" href="category?cateid=${tag}&index=${indexPvsN + 1}">Tiếp</a>
                    </li>
                </c:if>
            </ul>
        </nav>
